...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sessions::cmd_get_session_tasks,
            ...
            commands::issues::cmd_get_linear_issue,
            commands::issues::cmd_update_linear_issue_description,
            commands::issues::cmd_update_github_issue_description,
            commands::issues::cmd_update_jira_issue_description,
            commands::issues::cmd_list_github_labels,
            commands::issues::cmd_list_github_assignees,
            commands::issues::cmd_list_linear_labels,
            commands::issues::cmd_list_linear_members,
            commands::issues::cmd_list_jira_labels,
            commands::issues::cmd_list_jira_assignees,
            commands::issues::cmd_get_linear_viewer,
            commands::issues::cmd_get_jira_myself,
            commands::issues::cmd_create_github_issue,
            commands::issues::cmd_get_linear_teams,
            commands::issues::cmd_create_linear_issue,
            commands::issues::cmd_get_jira_projects,
            commands::issues::cmd_create_jira_issue,
