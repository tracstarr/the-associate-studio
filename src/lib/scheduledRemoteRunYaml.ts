// GitHub Actions workflow installed into .github/workflows/scheduled-remote-run.yml.
// Runs on a cron schedule and processes GitHub issues labeled "scheduled-run"
// by dispatching Claude Code for each issue.

export const SCHEDULED_REMOTE_RUN_YAML_CONTENT = `name: Scheduled Remote Run
on:
  schedule:
